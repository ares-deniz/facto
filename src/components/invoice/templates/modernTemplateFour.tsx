...
export const ModernTemplateFour = ({ data }: TemplateProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-indigo-500/85 text-white p-8 -mx-12 -mt-12 mb-8 rounded-b-lg">
      ...
      <div className="grid grid-cols-2 gap-8 mb-8">
        ...
        <div className="text-right">
          <h2 className="text-3xl font-bold text-indigo-500 mb-4">FACTURE</h2>
      ...
      <div className="mb-8">
        <table className="w-full">
          <thead>
            <tr className="bg-gray-100 border-b-2 border-indigo-600">
      ...
      <div className="flex justify-end mb-8">
        <div className="w-64 space-y-2">
          ...
          <div className="flex justify-between py-3 bg-indigo-400 text-white px-4 rounded">
