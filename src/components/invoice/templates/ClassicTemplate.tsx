...
export const ClassicTemplate = ({ data }: TemplateProps) => {
  ...
  return (
    <div
      className="bg-white text-gray-900 p-12 min-h-[297mm] shadow-xl border-8 border-double border-gray-800"
      style={{ width: '210mm' }}
    >
      {/* Header */}
      <div className="text-center border-b-4 border-gray-800 pb-6 mb-8 flex space-x-60">
        {data.companyLogo && (
