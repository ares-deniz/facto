...
export const ClassicTemplateYellow = ({ data }: TemplateProps) => {
  ...
  return (
    <div
      className="bg-white text-gray-900 p-12 min-h-[297mm] shadow-xl border-8 border-double border-yellow-200"
      style={{ width: '210mm' }}
    >
      {/* Header */}
      <div className="text-center border-b-4 border-yellow-600 pb-6 mb-8 flex space-x-60">
        {data.companyLogo && (
      ...
      <h2 className="text-4xl font-serif text-center mb-8 text-gray-800 border-b border-yellow-300 pb-4">
        FACTURE
      </h2>

      {/* Invoice info and client */}
      <div className="grid grid-cols-2 gap-8 mb-8">
        <div className="border-2 border-yellow-300 p-4 bg-yellow-100">
        ...
        <div className="border-2 border-yellow-300 p-4 bg-yellow-100">
          <div className="space-y-3 text-gray-900">
            <div className="flex justify-between border-b border-yellow-300 pb-2">
      ...
      {/* Items table */}
      <div className="mb-8 border-2 border-yellow-500">
        <table className="w-full">
          <thead>
            <tr className="bg-yellow-500/30 text-gray-800 border-b border-yellow-300">
          ...
          <tbody>
            {data.items.map((item, index) => (
              ...
              >
                ...
                <td className="text-center p-4 border-b border-yellow-300">
                  {item.quantity}
                </td>
                <td className="text-right p-4 border-b border-yellow-300">
                  €{item.unitPrice.toFixed(2)}
                </td>
                <td className="text-center p-4 border-b border-yellow-300">
                  {item.vatRate}%
                </td>
                <td className="text-right p-4 border-b border-yellow-300 font-semibold">
                  €
      ...
      <div className="flex justify-end mb-8">
        <div className="w-80 border-2 border-yellow-500">
          <div className="flex justify-between p-4 border-b border-yellow-300 bg-yellow-50">
          ...
          <div className="flex justify-between p-4 bg-yellow-600 text-white">
      ...
      {/* Footer */}
      <div className="text-center mt-8 pt-6 border-t-2 border-yellow-300 text-gray-600 text-sm" />
    </div>
  );
};
